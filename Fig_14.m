% Fig. 14: A double-period solution of intrinsic-escape system
% Change the following parameters in relaxation.m
% G = struct('NaP', 6.8, 'L', 3, 'I', 0.24, 'E', 0.14); % conductances, nS
% Theta = struct('h', -39, 'mp', -37); % half activations (mV)
% Sigma = struct('h', 9, 'mp', -6); % slopes

clear; clc;

d1 = 1; d2 = 1; d3 = 1;
theta_I = -36;  %intrinsic escape
tF = 1000;

initials = [-10.0000  -59.9614  -61.7675    0.4051    0.7240    0.4509];
