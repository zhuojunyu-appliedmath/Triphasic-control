% Fig. 11: lTRC for synaptic escape
...
% Change the event functions to be "value=P(3)-theta_imag";
...
% perturbed
initialsp = [-10.0000  -62.6276  -63.9006    0.4048    0.7410    0.3894];
