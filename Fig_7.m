% Fig. 7: Phase plane for cell 1 in intrinsic release, with several values of d1
...
d1 = 1; 
initials1 = [-10.0000  -62.4746  -63.8754    0.4055    0.7727    0.3972];
...
d1 = 1.3; 
initials2 = [-21.8971  -62.1578  -63.2633    0.2792    0.8332    0.5850];
options = odeset('RelTol',1e-8,'AbsTol',1e-8);
...
d1 = 0.7; 
initials3 = [-31.4290  -61.8968  -62.7388    0.2467    0.8773    0.7160];
options = odeset('RelTol',1e-8,'AbsTol',1e-8);
